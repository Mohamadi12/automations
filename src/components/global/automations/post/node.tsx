...
// Le composant PostNode est utilisé pour afficher les publications associées à une automatisation. Voici ce que vous devez savoir :
...
// Le composant utilise useQueryAutomation(id) pour récupérer les données de l'automatisation, y compris les publications.
// Affichage Conditionnel :
// Si l'automatisation a des publications, le composant affiche les détails des publications avec une icône et une description.
// Les publications sont affichées sous forme de vignettes avec des images.
