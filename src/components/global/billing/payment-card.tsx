...
// PaymentCard : Carte de paiement avec options.
// current : Plan actif, PRO ou FREE.
// landing : Propriétés spécifiques pour la page d'atterrissage.
// Button : Bouton interactif pour actions.
// PLANS : Données des fonctionnalités des plans.
