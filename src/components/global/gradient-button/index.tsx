...
// Composants utilisés : Button, Link, cn.
// Type de bouton : BUTTON ou LINK.
// Gradient : Fond dégradé personnalisé.
// Condition d'affichage : Affiche Button ou Link.
// Classes CSS : rounded-xl, p-[2px].
